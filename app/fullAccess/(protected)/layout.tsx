...
import { AppSidebar } from "@/components/fullAccess/sidebar";
...
export default async function ProtectedLayout({
    ...
    if (!user || user.type !== "fullAccess" || user.iss !== "pharmacube") {
        redirect("/");
    }
                ...
                <SidebarProvider className="flex flex-1 flex-col">
                    ...
                    <div className="flex flex-1">
                        ...
                        <main className="flex-1 mt-12 overflow-auto">
                            <div className="mx-auto w-full max-w-7xl md:px-4 flex flex-col min-h-full">
                                {children}
                            </div>
                        </main>
                    </div>
